...
// Modifying the PV_OpenCL class from Pathfinder/PV_OpenCL.hpp
typedef struct CV_OpenCL
{
	bool verbose_flag;
	cl_int err;
	int version;
	...
	void GetDevices();
	void BuildKernel(std::string binary_name,
		cl::Program::Binaries& bins);

	// This function wraps GetDevices and BuildKernel.
